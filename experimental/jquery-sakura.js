(function ($) {
    ...
    $.fn.sakura = function (options) {
        ...
        // Declarations.
        var documentHeight = $(document).height()*0.65;
        var documentWidth = $(document).width()*0.3;

      //  var boxHeight = $(document).height()*0.5;
      //  var boxWidth = $(document).width()*0.2;
        ...
        var petalCreator = function () {
          ...
          //  var startPosTop = -((Math.random() * 20) + 15);
            var startPosLeft = documentWidth*2 + Math.random() * (documentWidth);
            var startPosTop = documentHeight/2 -((Math.random() * 20) + 50);
        ...
        $(window).resize(function () {
            documentHeight = $(document).height()*0.65;
            documentWidth = $(document).width()*0.3;
        });
